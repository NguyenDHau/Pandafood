                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group has-default bmd-form-group">
                                                    <input type="text" class="form-control" name="name" value="{{$product->product_name}}" required readonly>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                                <select required readonly class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" name="category" title="Danh mục sản phẩm">--}}

                                                    @foreach($catelist as $cate)
{{--                                                        <option value="{{$cate->category_id}}" @if($product->category_id == $cate->category_id) selected @endif>{{$cate->category_title}}</option>--}}
                                                    @if($product->category_id == $cate->category_id) <input type="text" class="form-control" name="name" value="{{$cate->category_title}}" required readonly> @endif
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group bmd-form-group">
                                                    <input type="text" class="form-control" name="unit" value="{{$product->product_unit}}" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group bmd-form-group">
                                                    <input type="text" class="form-control" name="price" value="{{$product->product_price}}" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group bmd-form-group">
                                                    <input type="text" class="form-control" name="promotion" value="{{$product->product_promotion}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 col-sm-12">
                                                @if($product->product_condition == 1)
                                                    <input type="text" class="form-control" name="name" value="Còn hàng" required readonly>
                                                @else
                                                    <input type="text" class="form-control" name="name" value="Hết hàng" required readonly>
                                                @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput" style="">
                                                    ...
                                                    <div>
                                                        <span class=" btn-rose btn-round btn-file">
...
{{--                                                            <span class="fileinput-exists">Đổi ảnh</span>--}}
                                    ...
                                    <div class="col-md-7">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group bmd-form-group">
                                                    <textarea class="form-control" rows="5" name="description" readonly="">{{$product->product_description}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group bmd-form-group">
                                                    <textarea class="form-control" name="prodcontent" readonly="">{{$product->product_content}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
