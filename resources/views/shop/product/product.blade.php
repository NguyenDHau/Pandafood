                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach($productlist as $prod)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{asset('shop/product/edit/'.$prod->product_id)}}" class="btn btn-warning btn-just-icon">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <a href="{{asset('shop/product/delete/'.$prod->product_id)}}" class="btn btn-danger btn-just-icon" onclick="return confirm('Bạn có muốn xóa sản phẩm này không?')">
