                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach($orderslist as $order)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{asset('shop/order/edit/'.$order->order_id)}}" class="btn btn-warning btn-just-icon">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <a href="{{asset('shop/order/delete/'.$order->order_id)}}" class="btn btn-danger btn-just-icon" onclick="return confirm('Bạn có muốn xóa đơn hàng này không?')">
