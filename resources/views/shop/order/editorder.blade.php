                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group has-default bmd-form-group">
                                                    <input type="text" class="form-control" name="phone" value="{{$order->order_phone}}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group has-default bmd-form-group">
                                                    <input type="text" class="form-control" name="address" value="{{$order->order_address}}" required>
                                                </div>
                                            </div>
                                        </div>
