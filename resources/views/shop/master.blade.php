...
<div class="wrapper">
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="./assetscp/img/sidebar-1.jpg">
        ...
        <div class="sidebar-wrapper">
            <div class="user">
                ...
                <div class="user-info">
                    ...
                    <div class="collapse" id="ProfileAdmin">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('shop/profile')}}">
            ...
            <ul class="nav">
                <li class="nav-item ">
                    <a class="nav-link" href="{{asset('shop/dashboard')}}">
                ...
                <li class="nav-item ">
                    ...
                    <div class="collapse" id="Manage-Product">
                        <ul class="nav">
                            <li class="nav-item ">
                                <a class="nav-link" href="{{asset('shop/product')}}">
                                    <span class="sidebar-mini"> LIST </span>
                                    <span class="sidebar-normal"> Danh sách sản phẩm </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="{{asset('shop/product/add')}}">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{asset('shop/order')}}">
        ...
        <footer class="footer ">
            <div class="container">
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>, thiết kế bởi <a href="" target="_blank">AI team</a>
                </div>
            </div>
        </footer>
    </div>
