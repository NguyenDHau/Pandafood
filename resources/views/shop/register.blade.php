                ...
                <form class="form" method="POST" action="">
                    <div class="card card-login card-hidden">
                        <div class="card-header card-header-rose text-center">
                            ...
                            <h5 class="card-title">Shop Register</h5>
                        </div>
                        @include('errors.note')
                        <div class="card-body ">
                            ...
                            <span class="bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="shopName" placeholder="Tên shop" value="{{old('shopName')}}" required>
                                    <input type="hidden" name="userId" value="{{Auth::user()->user_id}}">
                                </div>
                            </span>
                        </div>
                        <div class="card-footer justify-content-center">
                            <button class="btn btn-rose btn-link btn-lg" name="submit" value="login">Tiếp tục</button>
                        </div>
                    </div>
                    {{csrf_field()}}
                </form>
