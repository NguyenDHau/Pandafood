<footer>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col1">
                        <div class="newsletter-wrap">
                            <h4>{{strtoupper($infoweb->info_name)}} - Nhà cung cấp thực phẩm sạch lớn nhất miền Trung</h4>
                        </div>
                    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-12 coppyright">© 2023 {{$infoweb->info_name}}. Bản quyền nội dung thuộc về {{$infoweb->info_name}}.</div>
